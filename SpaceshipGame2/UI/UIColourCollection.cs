...
namespace SpaceshipGame2.UI {
	struct UIColourCollection {
		...
		public static readonly UIColourCollection DefaultHover = new UIColourCollection { outline = new Pixel(220, 220, 220), fill = new Pixel(200, 200, 200), foreground = DefaultUp.fill };
